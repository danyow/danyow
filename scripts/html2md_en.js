// /**
//  * https://storage.googleapis.com/localized_docs/zh-cn/2021.2/UnityDocumentation.zip
//  *
//  *
//  *
//  */
...
//
// //要遍历的文件夹所在的路径
// let DIR_EN = path.resolve('../unity_doc/en_2021/')
...
//           md = md.replaceAll('../StaticFilesManual/', 'https://docs.unity3d.com/cn/2021.2/StaticFilesManual/')
//           md = md.replaceAll('../ScriptReference/', 'https://docs.unity3d.com/cn/2021.2/ScriptReference/')
//           md = md.replaceAll('../StaticFiles/', 'https://docs.unity3d.com/cn/2021.2/StaticFiles/')
//           md = md.replaceAll('../uploads/', 'https://docs.unity3d.com/cn/2021.2/uploads/')
